...
extconf_dir = Pathname( __FILE__ ).dirname
...
pwd = Dir.pwd
Dir.chdir "#{extconf_dir}/../../leveldb"
system "OPT=\"-O2 -DNDEBUG -fPIC\" make libleveldb.a" or abort
Dir.chdir pwd

set_platform_specific_variables!

$CFLAGS << " -I#{extconf_dir}/../../leveldb/include"
$INCFLAGS << " -I#{extconf_dir}/../../leveldb/include"
$LIBS << " -L#{extconf_dir}/../../leveldb -lleveldb"
